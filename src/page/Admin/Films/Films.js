...
import { QuanLyPhimAction, QuanLyPhimAction1, xoaPhimAction } from '../../../redux/action/QuanLyPhimAction';
import { Fragment } from 'react';
import { NavLink } from 'react-router-dom';
import { history } from './../../../App'
export default function Films () {

    const { arrPhimDefault } = useSelector(rootReducer => rootReducer.QuanLyPhimReducer);
